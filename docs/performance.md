...
The Unstructured SaaS API (`strategy=hi_res`, `languages=por`)
numbers below reflect the older single-command path — Mistral's
per-PDF wall is ~3 s at $0.002/page sync, ~$0.001/page batch.
